...
void XFrameResource::Prepare()
{
	...
	m_pCommandList->SetGraphicsRootDescriptorTable(GRDT_UVA_SBUFFER, GetAlphaRenderSBuffer()->GetUAVGpuHandle());
}
